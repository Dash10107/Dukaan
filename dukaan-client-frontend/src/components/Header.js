      ...
      <header className="header-upper py-3">
        <div className="container-xxl">
          <div className="flex justify-around items-center">
            <div className="">
              <h2>
                <Link className="text-white">Digic</Link>
              </h2>
            </div>
            {/* <div className="col-5">
            ...
            <div className="col-5">
              <div className="header-upper-links d-flex align-items-center justify-content-between">
                ...
                <div className="">
                  <button
                    onClick={handleClick}
                    className="text-white d-flex bg-transparent border-0 align-items-center  gap-10"
                  >
              ...
              <div className="">
                ...
                <div className="menu-links">
                  <div className=" flex justify-around items-center ">
                    ...
                    <button
                      onClick={logoutFunc}
                      className="btn text-white text-uppercase btn-danger"
                    >
                      Logout
                    </button>
                  </div>
