...
const Dashboard = () => {
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">ONDC Report</h1>
      <div className="aspect-w-16 aspect-h-9">
        <iframe
          title="ondc"
          src="https://app.fabric.microsoft.com/reportEmbed?reportId=a00aaa4c-d79a-403b-b19e-42d24f6d8b98&autoAuth=true&ctid=a64aeab6-f01b-462b-aa9c-44546386ff31"
          frameBorder="0"
