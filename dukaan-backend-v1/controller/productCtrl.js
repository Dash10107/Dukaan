...
const search = async (req, res) => {
  try {
    ...
    const searchBody = {
          ...
          must: [
            {
              multi_match: {
                query: query,
                fields: ["title^3", "description", "tags", "brand", "category"],
                fuzziness: "AUTO",
      ...
      size: 10, // Adjust this based on your needs
    }
...
const recommend = async (req, res) => {
  ...
  module.exports={createProduct,getaProduct,deleteProduct,updateProduct,getAllProduct,addToWishlist,rating,uploadImages,
    getProductsBySellerId, getSellerStats, bulkUploadProducts,search,recommend, getProductsForSeller}